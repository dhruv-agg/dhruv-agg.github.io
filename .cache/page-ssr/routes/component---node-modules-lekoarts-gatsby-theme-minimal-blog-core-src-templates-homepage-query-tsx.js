...
/** @jsx jsx */const List=({children})=>(0,theme_ui_esm/* jsx */.tZ)("section",{sx:{mb:[5,5,6],ul:{margin:0,padding:0},li:{listStyle:`none`,mb:3,a:{variant:`links.listItem`}},variant:`section_bottom`}},children);/* harmony default export */ const list = (List);
...
function MinimalBlogCoreHomepage({...props}){const{data:{allPost}}=props;return/*#__PURE__*/index_js_.createElement(homepage,Object.assign({posts:allPost.nodes},props));}
