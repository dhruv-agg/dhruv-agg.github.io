...
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog/src/components/tag.tsx
/** @jsx jsx */const Tag=({posts,pageContext})=>{const{tagsPath,basePath}=(0,use_minimal_blog_config/* default */.Z)();return (0,theme_ui_esm/* jsx */.tZ)(layout/* default */.Z,null,(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Flex */.kC,{sx:{alignItems:`center`,justifyContent:`space-between`,flexFlow:`wrap`}},(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Heading */.X6,{as:"h1",variant:"styles.h1",sx:{marginY:2}},pageContext.name),(0,theme_ui_esm/* jsx */.tZ)(gatsby_browser_entry.Link,{sx:t=>{var _t$styles;return{...((_t$styles=t.styles)===null||_t$styles===void 0?void 0:_t$styles.a),variant:`links.secondary`,marginY:2};},to:(0,replaceSlashes/* default */.Z)(`/${basePath}/${tagsPath}`)},"View all tags")),(0,theme_ui_esm/* jsx */.tZ)(listing/* default */.Z,{posts:posts,sx:{mt:[4,5]}}));};/* harmony default export */ const tag = (Tag);const Head=({pageContext})=>(0,theme_ui_esm/* jsx */.tZ)(seo/* default */.Z,{title:`Tag: ${pageContext.name}`});
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog/src/@lekoarts/gatsby-theme-minimal-blog-core/components/tag.tsx
function MinimalBlogCoreTag({...props}){const{data:{allPost}}=props;return/*#__PURE__*/index_js_.createElement(tag,Object.assign({posts:allPost.nodes},props));}
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog-core/src/templates/tag-query.tsx

/* harmony default export */ const tag_query = (MinimalBlogCoreTag);

const query = "950172255";
...
;
//# sourceMappingURL=component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-tag-query-tsx.js.map