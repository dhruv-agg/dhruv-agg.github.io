...
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3804);
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6657);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2625);
...
var spin = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_3__/* .keyframes */ .F4)({
  from: {
...
// EXTERNAL MODULE: external "/Users/dhruv_aggarwal/Documents/mlexperiments/dhruv-agg.github.io/node_modules/react/index.js"
var index_js_ = __webpack_require__(2625);
...
// EXTERNAL MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog/src/components/layout.tsx + 15 modules
var layout = __webpack_require__(6920);
...
/* harmony import */ var _utils_replaceSlashes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9706);
...
// EXTERNAL MODULE: external "/Users/dhruv_aggarwal/Documents/mlexperiments/dhruv-agg.github.io/node_modules/react/index.js"
var index_js_ = __webpack_require__(2625);
// EXTERNAL MODULE: ./node_modules/@lekoarts/themes-utils/dist/index.mjs
var dist = __webpack_require__(1639);
...
/* harmony default export */ const prism_react_renderer_prism = (prism);
...
/* harmony default export */ const prism_react_renderer_dist = (Highlight);
...
/** @jsx jsx */const Layout=({children,className=``})=>(0,theme_ui_esm/* jsx */.tZ)(lib/* MDXProvider */.Zo,{components:mdx_components},(0,theme_ui_esm/* jsx */.tZ)(emotion_react_esm/* Global */.xB,{styles:t=>({"*":{boxSizing:`inherit`},html:{WebkitTextSizeAdjust:`100%`},img:{borderStyle:`none`},pre:{fontFamily:`monospace`,fontSize:`1em`},"[hidden]":{display:`none`},"::selection":{backgroundColor:(0,theme_ui_css_esm/* get */.U2)(t,`colors.text`),color:(0,theme_ui_css_esm/* get */.U2)(t,`colors.background`)},a:{transition:`all 0.3s ease-in-out`,color:`text`}})}),(0,theme_ui_esm/* jsx */.tZ)(skip_nav,null,"Skip to content"),(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Container */.W2,null,(0,theme_ui_esm/* jsx */.tZ)(header,null),(0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Box */.xu,{id:"skip-nav",as:"main",variant:"layout.main",sx:{...styles_code},className:className},children),(0,theme_ui_esm/* jsx */.tZ)(footer,null)));/* harmony default export */ const layout = (Layout);
...
/* harmony export */ });
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7076);
const useSiteMetadata=()=>{const data=(0,gatsby__WEBPACK_IMPORTED_MODULE_0__.useStaticQuery)("2450661609");return data.site.siteMetadata;};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useSiteMetadata);
...
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(1151);
;// CONCATENATED MODULE: ./content/posts/markdown-reference/index.mdx
/*@jsxRuntime classic @jsx React.createElement @jsxFrag React.Fragment*/function _createMdxContent(props){const _components=Object.assign({h2:"h2",p:"p",strong:"strong",em:"em",ol:"ol",li:"li",h3:"h3",blockquote:"blockquote",img:"img",ul:"ul",a:"a",code:"code",pre:"pre",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",h4:"h4"},(0,lib/* useMDXComponents */.ah)(),props.components);return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(_components.h2,null,"What to expect from here on out"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"What follows from here is just a bunch of absolute nonsense I've written to dogfood the plugin itself. It includes every sensible typographic element I could think of, like ",/*#__PURE__*/index_js_default().createElement(_components.strong,null,"bold text"),", unordered lists, ordered lists, code blocks, block quotes, ",/*#__PURE__*/index_js_default().createElement(_components.em,null,"and even italics"),"."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"It's important to cover all of these use cases for a few reasons:"),"\n",/*#__PURE__*/index_js_default().createElement(_components.ol,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"We want everything to look good out of the box."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Really just the first reason, that's the whole point of the plugin."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Here's a third pretend reason though a list with three items looks more realistic than a list with two items."),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Now we're going to try out another header style."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"Typography should be easy"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"So that's a header for you — with any luck if we've done our job correctly that will look pretty reasonable."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Something a wise person once told me about typography is:"),"\n",/*#__PURE__*/index_js_default().createElement(_components.blockquote,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Typography is pretty important if you don't want your stuff to look like trash. Make it good then it won't be bad."),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"It's probably important that images look okay here by default as well:"),"\n",/*#__PURE__*/index_js_default().createElement(_components.img,{src:"https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80",alt:""}),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Now I'm going to show you an example of an unordered list to make sure that looks good, too:"),"\n",/*#__PURE__*/index_js_default().createElement(_components.ul,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"So here is the first item in this list."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"In this example we're keeping the items short."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Later, we'll use longer, more complex list items."),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"And that's the end of this section."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h2,null,"What if we stack headings?"),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"We should make sure that looks good, too."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Sometimes you have headings directly underneath each other. In those cases you often have to undo the top margin on the second heading because it usually looks better for the headings to be closer together than a paragraph followed by a heading should be."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"When a heading comes after a paragraph …"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"When a heading comes after a paragraph, we need a bit more space, like I already mentioned above. Now let's see what a more complex list would look like."),"\n",/*#__PURE__*/index_js_default().createElement(_components.ul,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,/*#__PURE__*/index_js_default().createElement(_components.strong,null,"I often do this thing where list items have headings.")),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"For some reason I think this looks cool which is unfortunate because it's pretty annoying to get the styles right."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"I often have two or three paragraphs in these list items, too, so the hard part is getting the spacing between the paragraphs, list item heading, and separate list items to all make sense. Pretty tough honestly, you could make a strong argument that you just shouldn't write this way."),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,/*#__PURE__*/index_js_default().createElement(_components.strong,null,"Since this is a list, I need at least two items.")),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"I explained what I'm doing already in the previous list item, but a list wouldn't be a list if it only had one item, and we really want this to look realistic. That's why I've added this second list item so I actually have something to look at when writing the styles."),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,/*#__PURE__*/index_js_default().createElement(_components.strong,null,"It's not a bad idea to add a third item either.")),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"I think it probably would've been fine to just use two items but three is definitely not worse, and since I seem to be having no trouble making up arbitrary things to type, I might as well include it."),"\n"),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"After this sort of list I usually have a closing statement or paragraph, because it kinda looks weird jumping right to a heading."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h2,null,"Code should look okay by default."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"I think most people are going to use ",/*#__PURE__*/index_js_default().createElement(_components.a,{href:"https://highlightjs.org/"},"highlight.js")," or ",/*#__PURE__*/index_js_default().createElement(_components.a,{href:"https://prismjs.com/"},"Prism")," or something if they want to style their code blocks but it wouldn't hurt to make them look ",/*#__PURE__*/index_js_default().createElement(_components.em,null,"okay")," out of the box, even with no syntax highlighting."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Here's what a default ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"tailwind.config.js")," file looks like at the time of writing:"),"\n",/*#__PURE__*/index_js_default().createElement(_components.pre,null,/*#__PURE__*/index_js_default().createElement(_components.code,{className:"language-js"},"module.exports = {\n  purge: [],\n  theme: {\n    extend: {},\n  },\n  variants: {},\n  plugins: [],\n};\n")),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Hopefully that looks good enough to you."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"What about nested lists?"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Nested lists basically always look bad which is why editors like Medium don't even let you do it, but I guess since some of you goofballs are going to do it we have to carry the burden of at least making it work."),"\n",/*#__PURE__*/index_js_default().createElement(_components.ol,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,/*#__PURE__*/index_js_default().createElement(_components.strong,null,"Nested lists are rarely a good idea."),"\n",/*#__PURE__*/index_js_default().createElement(_components.ul,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"You might feel like you are being really \"organized\" or something but you are just creating a gross shape on the screen that is hard to read."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Nested navigation in UIs is a bad idea too, keep things as flat as possible."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Nesting tons of folders in your source code is also not helpful."),"\n"),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,/*#__PURE__*/index_js_default().createElement(_components.strong,null,"Since we need to have more items, here's another one."),"\n",/*#__PURE__*/index_js_default().createElement(_components.ul,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"I'm not sure if we'll bother styling more than two levels deep."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Two is already too much, three is guaranteed to be a bad idea."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"If you nest four levels deep you belong in prison."),"\n"),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,/*#__PURE__*/index_js_default().createElement(_components.strong,null,"Two items isn't really a list, three is good though."),"\n",/*#__PURE__*/index_js_default().createElement(_components.ul,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Again please don't nest lists if you want people to actually read your content."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Nobody wants to look at this."),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"I'm upset that we even have to bother styling this."),"\n"),"\n"),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"The most annoying thing about lists in Markdown is that ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"<li>")," elements aren't given a child ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"<p>")," tag unless there are multiple paragraphs in the list item. That means I have to worry about styling that annoying situation too."),"\n",/*#__PURE__*/index_js_default().createElement(_components.ul,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,/*#__PURE__*/index_js_default().createElement(_components.strong,null,"For example, here's another nested list.")),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"But this time with a second paragraph."),"\n",/*#__PURE__*/index_js_default().createElement(_components.ul,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"These list items won't have ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"<p>")," tags"),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"Because they are only one line each"),"\n"),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,/*#__PURE__*/index_js_default().createElement(_components.strong,null,"But in this second top-level list item, they will.")),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"This is especially annoying because of the spacing on this paragraph."),"\n",/*#__PURE__*/index_js_default().createElement(_components.ul,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"As you can see here, because I've added a second line, this list item now has a ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"<p>")," tag."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"This is the second line I'm talking about by the way."),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Finally here's another list item so it's more like a list."),"\n"),"\n"),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.li,null,"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"A closing list item, but with no nested list, because why not?"),"\n"),"\n"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"And finally a sentence to close off this section."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h2,null,"There are other elements we need to style"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"I almost forgot to mention links, like ",/*#__PURE__*/index_js_default().createElement(_components.a,{href:"https://tailwindcss.com"},"this link to the Tailwind CSS website"),". We almost made them blue but that's so yesterday, so we went with dark gray, feels edgier."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"We even included table styles, check it out:"),"\n",/*#__PURE__*/index_js_default().createElement(_components.table,null,/*#__PURE__*/index_js_default().createElement(_components.thead,null,/*#__PURE__*/index_js_default().createElement(_components.tr,null,/*#__PURE__*/index_js_default().createElement(_components.th,null,"Wrestler"),/*#__PURE__*/index_js_default().createElement(_components.th,null,"Origin"),/*#__PURE__*/index_js_default().createElement(_components.th,null,"Finisher"))),/*#__PURE__*/index_js_default().createElement(_components.tbody,null,/*#__PURE__*/index_js_default().createElement(_components.tr,null,/*#__PURE__*/index_js_default().createElement(_components.td,null,"Bret \"The Hitman\" Hart"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Calgary, AB"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Sharpshooter")),/*#__PURE__*/index_js_default().createElement(_components.tr,null,/*#__PURE__*/index_js_default().createElement(_components.td,null,"Stone Cold Steve Austin"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Austin, TX"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Stone Cold Stunner")),/*#__PURE__*/index_js_default().createElement(_components.tr,null,/*#__PURE__*/index_js_default().createElement(_components.td,null,"Randy Savage"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Sarasota, FL"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Elbow Drop")),/*#__PURE__*/index_js_default().createElement(_components.tr,null,/*#__PURE__*/index_js_default().createElement(_components.td,null,"Vader"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Boulder, CO"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Vader Bomb")),/*#__PURE__*/index_js_default().createElement(_components.tr,null,/*#__PURE__*/index_js_default().createElement(_components.td,null,"Razor Ramon"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Chuluota, FL"),/*#__PURE__*/index_js_default().createElement(_components.td,null,"Razor's Edge")))),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"We also need to make sure inline code looks good, like if I wanted to talk about ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"<span>")," elements or tell you the good news about ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"@tailwindcss/typography"),"."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"Sometimes I even use ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"code")," in headings"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Even though it's probably a bad idea, and historically I've had a hard time making it look good. This ",/*#__PURE__*/index_js_default().createElement(_components.em,null,"\"wrap the code blocks in backticks\"")," trick works pretty well though really."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Another thing I've done in the past is put a ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"code")," tag inside of a link, like if I wanted to tell you about the ",/*#__PURE__*/index_js_default().createElement(_components.a,{href:"https://github.com/tailwindcss/docs"},/*#__PURE__*/index_js_default().createElement(_components.code,null,"tailwindcss/docs"))," repository. I don't love that there is an underline below the backticks but it is absolutely not worth the madness it would require to avoid it."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h4,null,"We haven't used an ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"h4")," yet"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"But now we have. Please don't use ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"h5")," or ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"h6")," in your content, Medium only supports two heading levels for a reason, you animals. I honestly considered using a ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"before")," pseudo-element to scream at you if you use an ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"h5")," or ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"h6"),"."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"We don't style them at all out of the box because ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"h4")," elements are already so small that they are the same size as the body copy. What are we supposed to do with an ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"h5"),", make it ",/*#__PURE__*/index_js_default().createElement(_components.em,null,"smaller")," than the body copy? No thanks."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"We still need to think about stacked headings though."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h4,null,"Let's make sure we don't screw that up with ",/*#__PURE__*/index_js_default().createElement(_components.code,null,"h4")," elements, either."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Phew, with any luck we have styled the headings above this text and they look pretty good."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Let's add a closing paragraph here so things end with a decently sized block of text. I can't explain why I want things to end that way but I have to assume it's because I think things will look weird or unbalanced if there is a heading too close to the end of the document."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"What I've written here is probably long enough, but adding this final sentence can't hurt."));}function MDXContent(props={}){const{wrapper:MDXLayout}=Object.assign({},(0,lib/* useMDXComponents */.ah)(),props.components);return MDXLayout?/*#__PURE__*/index_js_default().createElement(MDXLayout,props,/*#__PURE__*/index_js_default().createElement(_createMdxContent,props)):_createMdxContent(props);}/* harmony default export */ const markdown_reference = (MDXContent);
...
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog-core/src/templates/post-query.tsx?__contentFilePath=/Users/dhruv_aggarwal/Documents/mlexperiments/dhruv-agg.github.io/content/posts/markdown-reference/index.mdx



post/* default */.Z;
function GatsbyMDXWrapper(props) {
  return /*#__PURE__*/index_js_default().createElement(post/* default */.Z, props, /*#__PURE__*/index_js_default().createElement(markdown_reference, props));
}
...
;
//# sourceMappingURL=component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx-content-file-path-users-dhruv-aggarwal-documents-mlexperiments-dhruv-agg-github-io-content-posts-markdown-reference-index-mdx.js.map